      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 text-center">
          <div className="p-4 md:p-6 rounded-lg shadow hover:shadow-lg transition border">
            ...
            <a href="/map" className="text-green-600 font-semibold hover:underline">Voir les points</a>
          </div>
          <div className="p-4 md:p-6 rounded-lg shadow hover:shadow-lg transition border">
            ...
            <a href="#" className="text-green-600 font-semibold hover:underline">Trouver un réparateur</a>
          </div>
          <div className="p-4 md:p-6 rounded-lg shadow hover:shadow-lg transition border">
            ...
            <a href="/comprendre" className="text-green-600 font-semibold hover:underline">En savoir plus</a>
          </div>
        </div>
      </section>
    );
