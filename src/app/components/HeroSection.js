export default function HeroSection() {
    return (
      <section className="bg-green-100 py-16 text-center">
        ...
        <a href="/map" className="inline-block bg-green-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-green-700 transition">Trouver un point de collecte</a>
      </section>
    );
  }
