export default function UserHistory({ user }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow p-6 md:p-1 w-full max-w-md mx-auto ">
      <div className="text-lg font-bold text-green-800 mb-2">Mon historique</div>
      <ul className="divide-y divide-green-100">
        {history.map((item, idx) => (
          <li key={idx} className="py-2 flex flex-col md:flex-row md:items-center md:gap-3 text-sm min-w-[320px]">
