  ...
  return (
    <main className="min-h-screen bg-green-50 py-12 px-4">
      ...
      <article className="max-w-3xl mx-auto bg-white rounded-xl shadow p-8 animate-fadein">
        ...
        <p className="mb-4 text-gray-800">Recycler permet de limiter la pollution, d'éapos;économiser les ressources naturelles et de réduire la quantité de déchets enfouis ou incinérés. C'est un geste simple qui a un impact direct sur la préservation de notre planète.</p>
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-800">
          ...
          <li>Diminution des émissions de gaz àagrave; effet de serre.</li>
        ...
        <p className="mb-4 text-gray-800">Triez vos équipements usagés, déposez-les dans les points de collecte adaptés et sensibilisez votre entourage àagrave; l'importance du recyclage. Chaque geste compte pour un avenir plus durable.</p>
