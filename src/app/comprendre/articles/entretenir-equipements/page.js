  ...
  return (
    <main className="min-h-screen bg-green-50 py-12 px-4">
      ...
      <article className="max-w-3xl mx-auto bg-white rounded-xl shadow p-8 animate-fadein">
        ...
        <p className="mb-4 text-gray-800">Un bon entretien permet de prolonger la durée de vie de vos équipements, d'éapos;éviter les pannes prématurées et de réduire la production de déchets électroniques. Cela contribue aussi àagrave; faire des économies et àagrave; préserver l'environnement.</p>
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-800">
          ...
          <li>Débranchez les appareils non utilisés pour économiser l'éapos;énergie.</li>
        ...
        <p className="mb-4 text-gray-800">Si un appareil ne fonctionne plus malgré un bon entretien, pensez àagrave; la réparation avant d'envisager le recyclage. De nombreux réseaux de réparateurs existent. Si la réparation n'est pas possible, déposez l'appareil dans un point de collecte pour qu'il soit recyclé dans les meilleures conditions.</p>
