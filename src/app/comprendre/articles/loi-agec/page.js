  ...
  return (
    <main className="min-h-screen bg-green-50 py-12 px-4">
      ...
      <article className="max-w-3xl mx-auto bg-white rounded-xl shadow p-8 animate-fadein">
        ...
        <p className="mb-4 text-gray-800">La loi AGEC (Anti-Gaspillage pour une Économie Circulaire) vise &agrave; transformer notre modèle de production et de consommation pour limiter le gaspillage, favoriser le recyclage et encourager la réparation.</p>
        ...
        <ul className="list-disc pl-6 mb-4 text-gray-800">
          <li>Réduire l&apos;utilisation du plastique &agrave; usage unique.</li>
        ...
        <div className="mt-8 text-sm text-gray-500">Publié par Eco-Tec Cycle | Mis &agrave; jour en 2025</div>
      </article>
    </main>
  );
} 