...
export const metadata = {
  ...
  description: "Comprenez la loi AGEC, ses objectifs pour l'économie circulaire, et son impact sur le recyclage et la réparation des équipements électroniques.",
